...
void Robot::choisir()
{
    int n,x,y, m, i, j, l, k, obstacles;
    cout << "donner le nombre de ligne de la zone" << endl;
    cin >> n;
    cout << "donner le nombre de colone de la zone" << endl;
    cin >> m;
    i = j = l = k = 1000;
    zone.setlc(n, m);
    ...
    while (i > m)
    {
        cout << "donner la position du depart suivant les lignes " << endl;
        cin >> i;
    ...
    while (j > n)
    {
        cout << "donner la position du depart suivant les colones " << endl;
        cin >> j;

    }depj = j;
    while (l> n)
    {
        cout << "donner la position d'arrive suivant les lignes" << endl;
        cin >> l;

    }arrivi = l;
    while (k> m)
    {
        cout << "donner la position d'arrive suivant les colonnes " << endl;
        cin >> k;
    ...
    {
        cout << "donner le nombre d'obstacles  " << endl;
        cin >> obstacles;
    }
